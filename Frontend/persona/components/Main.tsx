    ...
    <>
      ...
      <div className={style.smart}>
        ...
        <div className={style.right}>
          <Image src="/Main_smart.jpg" alt="smart" width="500" height="350" />
        </div>
      </div>
      <div className={style.easy}>
        <div className={style.left}>
          <Image src="/Main_easy.jpg" alt="easy" width="500" height="350" />
        </div>
        <div className={style.right}>
      ...
      <div className={style.simple}>
        ...
        <div className={style.right}>
          <Image src="/Main_simple.jpg" alt="simple" width="500" height="400" />
        </div>
      </div>
      <div className={style.exciting}>
        <div className={style.left}>
          <Image src="/Main_exciting.jpg" alt="exciting" width="500" height="350" />
        </div>
        <div className={style.right}>
