    ...
    <>
      ...
      <div className={style.introduce}>
        ...
        <div>
          ...
          시작해보세요!
          <br />
          온라인으로 시간과 공간에 제약을 받지 않아 자유롭게 연습할 수 있고, AI 감정 분석 등 다양한 기능을 제공받을 수
          있습니다.
        </div>
      </div>
      <div className={style.smart}>
        ...
        <div className={style.right}>
          <img src="Main_smart.jpg" alt="smart" width="500" height="350" />
        </div>
      </div>
      <div className={style.easy}>
        <div className={style.left}>
          <img src="Main_easy.jpg" alt="easy" width="500" height="350" />
        </div>
        <div className={style.right}>
          ...
          <div className={style.content}>
            ...
            페르소나는 대 본부터 분석, 연습 프로그램까지 제공합니다. <br />
      ...
      <div className={style.simple}>
        <div className={style.left}>
          ...
          <div className={style.content}>
            ...
            연기는 연습 뿐만 아니라 자신의 연기를 직접 모니터링 하며 피드백하는 과정도 필요합니다! <br />
            연기 연습 후 영상과 대본 분석을 보관할 수 있고, 이를 통해 셀프 피드백이 가능합니다.
          </div>
        </div>
        <div className={style.right}>
          <img src="Main_simple.jpg" alt="simple" width="500" height="400" />
        </div>
      </div>
      <div className={style.exciting}>
        <div className={style.left}>
          <img src="Main_exciting.jpg" alt="exciting" width="500" height="350" />
        </div>
        <div className={style.right}>
          ...
          <div className={style.content}>
            ...
            보관함에 있는 나의 연기를 다른 사람들과 공유할 수 있어 쉽고 빠르게 피드백을 받을 수 있습니다. <br />
          </div>
        </div>
      </div>
    </>
